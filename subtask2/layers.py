...
import subtask2.operations as op
...
def CNN_3d_3bn(x, out_channels, kernel_size=3, fc_size=1024 ,add_relu=True, is_training = False):
    '''Add a 3d convlution layer with relu and max pooling layer.
    ...
    with tf.variable_scope('conv_0'):
        ...
        pooling_0 = tf.layers.max_pooling3d(
            inputs=conv_0,
            pool_size=[1,3,3],
            strides=[1,3,3],
            padding='same'
    ...
    with tf.variable_scope('conv_1'):
        conv_1 = tf.layers.conv3d(
            ...
            kernel_size=[kernel_size[1][0], kernel_size[1][1], kernel_size[1][2]],
            kernel_initializer=tf.random_uniform_initializer(-0.01, 0.01),
            padding='same',
            activation=tf.nn.elu,
            reuse=tf.AUTO_REUSE
        ...
        pooling_1 = tf.layers.max_pooling3d(
            inputs=conv_1,
            pool_size=[3,3,3],
            strides=[3,3,3],
            padding='same'
    ...
    with tf.variable_scope('conv_2'):
        conv_2 = tf.layers.conv3d(
            ...
            kernel_size=[kernel_size[2][0], kernel_size[2][1], kernel_size[2][2]],
            kernel_initializer=tf.random_uniform_initializer(-0.01, 0.01),
            padding='same',
            activation=tf.nn.elu,
            name='a',
        ...
        conv_2 = tf.layers.conv3d(
            inputs=conv_2,
            filters=out_channels[2],
            kernel_size=[kernel_size[3][0], kernel_size[3][1], kernel_size[3][2]],
            kernel_initializer=tf.random_uniform_initializer(-0.01, 0.01),
            padding='same',
            activation=tf.nn.elu,
            name='b',
        ...
        pooling_2 = tf.layers.max_pooling3d(
            inputs=conv_2,
            pool_size=[3,3,3],
            strides=[3,3,3],
            padding='same'
...
def CNN_3d_3(x, out_channels, add_relu=True, is_training = False):
    '''Add a 3d convlution layer with relu and max pooling layer.
    ...
    weights_0 = tf.get_variable(
        name='filter_0',
        shape=[3, 3, 3, in_channels, out_channels[0]],
        dtype=tf.float32,
        initializer=tf.random_uniform_initializer(-0.01, 0.01))
    bias_0 = tf.get_variable(
        name='bias_0',
    ...
    weights_1 = tf.get_variable(
        name='filter_1',
        shape=[3, 3, 3, out_channels[0], out_channels[1]],
        dtype=tf.float32,
        initializer=tf.random_uniform_initializer(-0.01, 0.01))
    bias_1 = tf.get_variable(
        name='bias_1',
    ...
    weights_2 = tf.get_variable(
        name='filter_2',
        shape=[3, 3, 3, out_channels[1], out_channels[2]],
        dtype=tf.float32,
        initializer=tf.random_uniform_initializer(-0.01, 0.01))
