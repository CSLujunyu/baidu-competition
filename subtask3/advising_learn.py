...
import subtask3.net as net
import subtask3.train_and_evaluate as train


# configure
raw_data_path = '/hdd/lujunyu/dataset/DSTC7_track1/subtask3/'
model_data_path = '/hdd/lujunyu/dataset/DSTC7_track1/model_data/Advising/s3/'
model_path = '/hdd/lujunyu/model/DSTC7/Advising/s3/'
...
advising_conf = {
    ...
    "reg_rate":3e-5,
    "drop_rate": 0.3,
    "vocab_size": 5620,    #434513 for DAM  ， 128205 for dstc
    "emb_size": 300,
